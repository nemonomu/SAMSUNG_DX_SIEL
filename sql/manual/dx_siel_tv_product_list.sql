-- =============================================================================
-- dx_siel_tv_product_list  — TV main + bsr 통합 테이블 (운영)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS dx_siel_tv_product_list (
...
CREATE INDEX IF NOT EXISTS idx_dx_siel_tv_product_list_lookup
  ON dx_siel_tv_product_list (account_name, product, item);
