-- =============================================================================
-- dx_siel_ldy_retail_com  — LDY 제품 최종 통합 테이블 (운영)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS dx_siel_ldy_retail_com (
...
CREATE INDEX IF NOT EXISTS idx_dx_siel_ldy_retail_com_lookup
  ON dx_siel_ldy_retail_com (account_name, product, item);
