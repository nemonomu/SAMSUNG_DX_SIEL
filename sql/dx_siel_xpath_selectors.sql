  ...
  FOREACH d IN ARRAY domains LOOP
    ...
    VALUES
      ...
      ('Flipkart','detail',d,'discount_type',
       ...
       NULL,
       '사용자 검수 (5/9 #3): detail page layout 변형 다수 — cls "HZ0E6r" 미사용 page 존재. 단어 list. Bank Offer/Bank offer 제외 + Saver Deal/SALE PE SALE/Lowest Price Live 추가 (Lowest Price Live deal type 인정 — 본 element text 가 "Lowest Price Live • Ends in 08d 14h 56s" 형식, 추출당시 count down 값 그대로 저장). detail.py 분기에서 multi-match 합침 + Bank Offer/재고/Exchange 영역 필터.'),
