  ...
  FOREACH d IN ARRAY domains LOOP
    ...
    VALUES
      ...
      ('Amazon','main',d,'final_sku_price',
       './/span[@class="a-price" and @data-a-color="base"]//span[@class="a-offscreen"] | .//span[contains(@class,"a-color-state") and contains(text(),"Currently unavailable")]',
       './/span[contains(@class,"a-price") and not(@data-a-strike)]//span[@class="a-offscreen"]',
       '가격 매치 우선 (DOM 순서) — 가격 부재 시 "Currently unavailable." text 캡처. 4 도메인 공통'),
