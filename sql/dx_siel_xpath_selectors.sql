...
VALUES
  ...
  ('Flipkart','detail','tv','screen_size',
   '(//div[contains(text(),"inch") and contains(text(),"cm") and not(ancestor::h1) and not(ancestor::head) and not(ancestor::a)])[1]',
   '//div[normalize-space(text())="Display Size:"]/following-sibling::div[1]',
   'product highlights 첫 번째 div (e.g. "LED 108 cm (43 inch)"). h1 / a 안 (제품명 / 링크) 제외'),
