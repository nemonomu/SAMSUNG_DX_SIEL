...
VALUES
  ...
  ('Amazon','detail','tv','sku',
   ...
   '//table//tr[.//th[normalize-space()="Model Number" or normalize-space()="Part Number" or normalize-space()="Item Model Number" or normalize-space()="Item model number"]]/td',
   'TV: Manufacturer Part Number primary. fallback union (Model Number | Part Number | Item Model Number | Item model number) — 5/8 진단 발견 (SANSUI 같은 정상 브랜드 일부는 Manufacturer Part Number 라벨 부재, Model Number 만 있음)'),
...
VALUES
  ...
  ('Amazon','detail','ref','sku',
   '//table//tr[.//th[contains(text(),"Manufacturer") and contains(text(),"Part Number")]]/td',
   '//table//tr[.//th[normalize-space()="Model Number" or normalize-space()="Part Number" or normalize-space()="Item Model Number" or normalize-space()="Item model number"]]/td',
   'REF: Manufacturer Part Number primary. fallback union (Model Number | Part Number | Item Model Number | Item model number) — 5/8 진단 발견 (Midea 같은 정상 브랜드 일부는 "Part Number" 라벨만 사용)'),
...
VALUES
  ...
  ('Amazon','detail','ldy','sku',
   '//table//tr[.//th[contains(text(),"Manufacturer") and contains(text(),"Part Number")]]/td',
   '//table//tr[.//th[normalize-space()="Model Number" or normalize-space()="Part Number" or normalize-space()="Item Model Number" or normalize-space()="Item model number"]]/td',
   'LDY: Manufacturer Part Number primary. fallback union (Model Number | Part Number | Item Model Number | Item model number) — 5/8 진단 발견. spam product (대소문자 noise) 일부도 매치될 수 있으나 NULL 보다 낫고 spam filter 는 별 트랙'),
  ...
  FOREACH d IN ARRAY domains LOOP
    ...
    VALUES
      ...
      ('Flipkart','main',d,'discount_type',
       './/*[contains(text(),"Hot Deal") or contains(text(),"Hot deal") or contains(text(),"Super Deals") or contains(text(),"Bank offer") or contains(text(),"Bank Offer") or contains(text(),"Limited time") or contains(text(),"Limited Time") or contains(text(),"Big Saving") or contains(text(),"Coupon") or contains(text(),"Special Price") or contains(text(),"Deal of") or contains(text(),"Trending") or contains(text(),"Early bird") or contains(text(),"Early Bird")]',
       NULL,
       '사용자 정책: deal type 매치. 정밀화 (5/7 noise 회피): "Limited" → "Limited time/Time" (Apple Warranty 회피), "Special" → "Special Price" (Wash Motor Special Warranty 회피). "Early bird/Bird" 추가 (5/6 신규 deal type). % off 는 savings 별도'),
  ...
  FOREACH d IN ARRAY domains LOOP
    ...
    VALUES
      ...
      ('Flipkart','detail',d,'discount_type',
       '//*[contains(text(),"Hot Deal") or contains(text(),"Hot deal") or contains(text(),"Super Deals") or contains(text(),"Bank offer") or contains(text(),"Bank Offer") or contains(text(),"Limited time") or contains(text(),"Limited Time") or contains(text(),"Big Saving") or contains(text(),"Coupon") or contains(text(),"Special Price") or contains(text(),"Deal of") or contains(text(),"Trending") or contains(text(),"Early bird") or contains(text(),"Early Bird")]',
       NULL,
       'main page selector 와 동일 union (5/7 정밀화 적용). main fallback 시 형식 일관'),
