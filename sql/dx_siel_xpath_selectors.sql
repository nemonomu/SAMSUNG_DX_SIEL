...
VALUES
  ...
  ('Amazon','detail','hhp','retailer_sku_name_similar',
   '//*[contains(@id,"anonCarousel")]//li[contains(@class,"a-carousel-card")]//a[contains(@href,"/dp/")]//*[contains(@class,"a-truncate-full")] | //*[contains(@id,"anonCarousel")]//li//div[contains(@class,"a-truncate-full")]',
   '//*[contains(@id,"sims-fbt")]//div[contains(@class,"a-truncate-full")]',
   'carousel-card 한정 + dp link 안의 truncate-full 만 — review count/가격 노이즈 제거'),
...
VALUES
  ...
  ('Amazon','detail','tv','retailer_sku_name_similar',
   '//*[contains(@id,"anonCarousel")]//li[contains(@class,"a-carousel-card")]//a[contains(@href,"/dp/")]//*[contains(@class,"a-truncate-full")] | //*[contains(@id,"anonCarousel")]//li//div[contains(@class,"a-truncate-full")]',
   NULL, 'carousel-card 한정 + dp link 안의 truncate-full 만 — review count/가격 노이즈 제거'),
  ...
  FOREACH d IN ARRAY domains LOOP
    ...
    VALUES
      ...
      ('Flipkart','detail',d,'count_of_reviews',
       '//div[@dir="auto" and contains(text(),"reviews") and contains(text(),"ratings")]',
       NULL,
       '"9,687 ratings and 561 reviews" — review page navigate 후 추출 (product page 엔 없음). siel_log.parse_count_of_reviews 가 reviews 앞 숫자만'),
