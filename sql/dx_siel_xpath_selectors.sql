  ...
  FOREACH d IN ARRAY domains LOOP
    ...
    VALUES
      ...
      ('Flipkart','detail',d,'detailed_review_content',
       ...
       '리뷰 본문 다중 — review page 진입 후. max 20'),
...
VALUES
  ...
  ('Flipkart','detail','hhp','trade_in',
   '//div[normalize-space(text())="Exchange offer"]/following-sibling::div[1] | //div[normalize-space(text())="Exchange offer"]/following::div[1]',
