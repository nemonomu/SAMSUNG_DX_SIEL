...
VALUES
  ...
  ('Amazon','detail','hhp','summarized_review_content',
   ...
   '리뷰 AI 요약 — cr-insights-widget (신) | reviewsMedley (구) union'),
  ...
  ('Amazon','detail','hhp','sku',
   '//div[@id="detailBullets_feature_div"]//li[.//span[contains(text(),"ASIN")]]/span[2] | //table[contains(@id,"productDetails_detailBullets") or contains(@id,"productDetails_techSpec") or contains(@id,"productDetails_expanderTables")]//tr[.//th[contains(text(),"ASIN")]]/td',
   '//div[@id="detailBullets_feature_div"]//li[.//span[contains(text(),"ASIN")]]/span[2]',
   'HHP ASIN: detailBullets li[2] (신, primary) | productDetails table (구). label-based'),
