...
def repl(driver, url: str):
    ...
    while True:
        ...
        SHORTCUTS = {
            ...
            'mratings':  '//span[contains(text(),"Ratings")]',
            'mreviews':  '//span[contains(text(),"Reviews")]',
            'mprice':    '//div[starts-with(normalize-space(text()),"₹")]',
            'msaving':   '//*[contains(text(),"% off") or contains(text(),"%")]',
            'mdiscount': '//*[contains(text(),"Hot Deal") or contains(text(),"Hot deal") or contains(text(),"Bank Offer") or contains(text(),"Bank offer") or contains(text(),"Super Deals")]',
